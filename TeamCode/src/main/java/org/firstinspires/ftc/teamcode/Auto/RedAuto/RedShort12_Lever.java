...
@Autonomous(name = "Red Short -12 Lever")
public class RedShort12_Lever extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        PathChain Path1 = new PathBuilder(follower)
                .addPath(
                        new BezierLine(new Pose(111.000, 137.500), new Pose(91.000, 83.000))
                )
        ...
        PathChain Path2 = new PathBuilder(follower)
                .addPath(
                        new BezierLine(new Pose(91.000, 83.000), new Pose(128.000, 83.000))
                )
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .build();
        ...
        PathChain Path4 = new PathBuilder(follower)
                .addPath(
                        new BezierLine(new Pose(131.000, 75.000), new Pose(91.000, 83.000))
                )
        ...
        PathChain Path5 = new PathBuilder(follower)
                .addPath(
                        new BezierCurve(
                                new Pose(91.000, 83.000),
                                new Pose(95.000, 53.000),
        ...
        PathChain Path6 = new PathBuilder(follower)
                .addPath(
                        new BezierLine(new Pose(129.000, 59.000), new Pose(91.000, 83.000))
                )
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .build();
        ...
        PathChain Path7 =new PathBuilder(follower)
                .addPath(
                        new BezierCurve(
                                new Pose(91.000, 83.000),
                                new Pose(94.000, 42.000),
                                new Pose(91.000, 34.000),
        ...
        PathChain Path8 =new PathBuilder(follower)
                .addPath(
                        new BezierLine(new Pose(132.000, 35.000), new Pose(91.000, 83.000))
                )
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .build();
        PathChain Path9 =new PathBuilder(follower)
                .addPath(
                        new BezierLine(new Pose(91.000, 83.000), new Pose(91.000, 63.000))
                )
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .build();
